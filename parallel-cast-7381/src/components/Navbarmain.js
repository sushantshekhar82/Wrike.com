...
import "./Index.css";
import {Home,Inbox,Mail,Feather,Share2,Trash2,UserPlus} from 'react-feather'
function Navbarmain() {
      ...
      {[false].map((expand) => (
        <Navbar key={expand}  expand={expand} className="mb-1 nav">
          <Container fluid>
            ...
            <Navbar.Toggle className='white' aria-controls={`offcanvasNavbar-expand-${expand}`} />
            <Home/> <Mail/>
            </div>
            <div>
             <img className='imghome' src="https://www.ntaskmanager.com/wp-content/uploads/2020/09/wrike-project-management.png" alt='wrike'/>
            </div>
            <div>
            ...
            >
              ...
              <Offcanvas.Body>
                <Nav className="justify-content-end flex-grow-1 pe-3">
                  <Nav.Link href="#"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="green" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>  Personal</Nav.Link>
                  <Nav.Link href="#"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="skyblue" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-feather"><path d="M20.24 12.24a6 6 0 0 0-8.49-8.49L5 10.5V19h8.5z"></path><line x1="16" y1="8" x2="2" y2="22"></line><line x1="17.5" y1="15" x2="9" y2="15"></line></svg>  Client Project</Nav.Link>
                  <Nav.Link href="#"><Share2/>  Share</Nav.Link>
                  <Nav.Link href="#"><UserPlus/>  Share</Nav.Link>
                  <Nav.Link href="#"><Trash2/>  Recyclebin</Nav.Link>
